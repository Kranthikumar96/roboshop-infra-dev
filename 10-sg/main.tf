...
#   source = "../../terraform-aws-securitygroup"
  source = "git::https://github.com/Kranthikumar96/terraform-aws-securitygroup.git?ref=main"
  project = var.project
  environment = var.environment

  sg_name = "mongodb"
  sg_description = "for roboshop dev mongodb database"
  vpc_id = local.vpc_id
}
...
#   source = "../../terraform-aws-securitygroup"
  ...
  sg_name = "redis"
  sg_description = "for roboshop dev redis database"
  vpc_id = local.vpc_id
}
...
#   source = "../../terraform-aws-securitygroup"
  ...
  sg_name = "mysql"
  sg_description = "for roboshop dev mysql database"
  vpc_id = local.vpc_id
}
...
#   source = "../../terraform-aws-securitygroup"
  ...
  sg_name = "rabbitmq"
  sg_description = "for roboshop dev rabbitmq database"
  vpc_id = local.vpc_id
}
...
#   source = "../../terraform-aws-securitygroup"
  ...
  sg_name = "catalogue"
  sg_description = "for roboshop dev catalogue database"
  vpc_id = local.vpc_id
}
...
#   source = "../../terraform-aws-securitygroup"
  ...
  sg_name = var.bastion_sg_description
  sg_description = var.bastion_sg_description
  vpc_id = local.vpc_id
}
...
# Backend ALB
resource "aws_security_group_rule" "bastion_alb_vpn" {
  type              = "ingress"
  from_port         = 80
  to_port           = 80
  protocol          = "tcp"
...
# open_vpn ports 22, 443, 1194, 943
resource "aws_security_group_rule" "open_vpn_ssh" {
  type              = "ingress"
  from_port         = 22
  to_port           = 22
  protocol          = "tcp"
...
resource "aws_security_group_rule" "open_vpn_https" {
  type              = "ingress"
  from_port         = 443
  to_port           = 443
  protocol          = "tcp"
...
/* # backend alb accepting connections from vpn host on port n.o 80
resource "aws_security_group_rule" "bastion_alb_vpn" {
  type              = "ingress"
  from_port         = 80
  to_port           = 80
